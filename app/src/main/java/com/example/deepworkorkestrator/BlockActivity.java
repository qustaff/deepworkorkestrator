...
public class BlockActivity extends Activity {
    ...
    private final Runnable checkForegroundRunnable = new Runnable() {
        ...
        public void run() {
            if (!isFinishing()) {
                // Keep the activity on top but allow system navigation
                getWindow().addFlags(
                ...
                // Hide system UI but allow navigation gestures
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set window flags - removed FLAG_ALLOW_LOCK_WHILE_SCREEN_ON to allow system navigation
        getWindow().addFlags(
            WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON |
            WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD |
            WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON |
        ...
        // Set exit button listener - modified to not disable blocking
        exitButton.setOnClickListener(v -> {
            // Just finish the activity without disabling blocking
            finish();
        });
